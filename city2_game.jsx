...
const SIMULATION = {
  ...
  bus: {
    ...
    poorMobilityGainBelowFlip:  0.30,
    poorMobilityLossAboveFlip:  0.10,
    richMobilityGainBelowFlip:  0.08,
...
const ADVISOR = {
  ...
  tooltips: {
    ...
    mobility:     "City mobility: 60% poor + 40% rich. Uber tax reduces mobility — hitting poor hardest. Bus helps when below 50, constrains above. AC offsets seasonal drops.",
    ...
    busSubsidy:   "Discount on bus fares. Strong effect on poor. Mobility flips above 50. Always reduces congestion. Costs budget.",
...
function simulate(uberTax, busSubsidy, acLevel, roundIndex, budgetRemaining) {
  ...
  const poorBusEffect = poorMobilityBeforeBus < bus.mobilityFlipPoint
  ...
  const richBusEffect = richMobilityBeforeBus < bus.mobilityFlipPoint
  ...
  const busIsConstraining = (poorMobilityBeforeBus >= bus.mobilityFlipPoint || richMobilityBeforeBus >= bus.mobilityFlipPoint) && busSubsidy > 0;
